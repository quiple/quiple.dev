...
export default component$(() => {
  ...
  const drawFontImage = $(async (event: SubmitEvent, target: HTMLFormElement) => {
    ...
    for (let i = 0; i < shadowPosition.length; i++) {
      if (shadowPosition[i]) position.push(shadowPosition[i].split(' ').map((f) => Number(f)))
    }
                  ...
                  <textarea
                    ...
                    lang={
                      [
                        ...
                        'shiftjis',
                        'shiftjis_level1',
                      ].some((charset) => charsetCurrent.value.startsWith(charset))
                        ? 'ja'
                        : 'ko'
                    }
        ...
        <article class="prose prose-sm prose-zinc max-w-full">
          ...
          <ul>
            ...
            <li>
              ...
              <ul>
                <li>
                  EUC-KR: KS X 1001과 KS X 1003을 포함하는 문자 집합. 라틴 문자와 기호, 한자 등을
                  포함합니다.
                </li>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  제1수준 한자만 포함: Shift_JIS에서 JIS X 0208의 제2수준 한자 3390자를 제외한 문자
                  집합.
                </li>
              </ul>
            </li>
          ...
          <p>
            &copy; 2024 Lee Minseo. 각 폰트는 해당 소유자 및 사용 허가자의 상표 및 저작권
            자산입니다.
          </p>
        </article>
      </aside>
