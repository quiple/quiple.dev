...
export const fonts: font[] = [
  {family: `${bigFamily}14`, name: `${bigFamily}14`, size: 15, slug: 'g14'},
  {family: `${bigFamily}11`, name: `${bigFamily}11`, size: 12, slug: 'g11'},
  ...
  {family: `${bigFamily}9`, name: `${bigFamily}9`, size: 10, slug: 'g9'},
  {family: `${bigFamily}7`, name: `${bigFamily}7`, size: 8, slug: 'g7'},
  {
